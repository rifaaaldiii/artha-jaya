    ...
    <div class="page">
        ...
        <div class="info-section">
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="info-separator">:</td>
                    <td class="info-value">{{ $row['branch'] ?? '-' }}</td>
                    <td class="info-label">Team Produksi</td>
                    <td class="info-separator">:</td>
                    <td class="info-value">{{ $row['team'] ?? '-' }}</td>
                </tr>
            </table>
        </div>
        ...
        <div class="production-box">
            ...
            <div class="production-info-grid">
                <div class="production-info-row">
                    <div class="production-info-label">Tanggal Dibuat</div>
                    <div class="production-info-value">: {{ $row['created_at'] ?? '-' }}</div>
                </div>
                <div class="production-info-row">
                    <div class="production-info-label">Total Item</div>
                    <div class="production-info-value">: {{ $row['items_count'] ?? 0 }} item</div>
                </div>
            </div>
        </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                @else
                    <tr>
                        <td colspan="5" style="text-align: center; padding: 8mm; color: #94a3b8; font-style: italic;">
