            ...
            <div class="flex flex-col gap-3" style="gap:0.75rem;">
                ...
                <div class="fi-actions">
                    ...
                    <x-filament::button
                        ...
                        wire:click="downloadInvoiceByDateRange"
                        wire:loading.attr="disabled"
                        wire:target="downloadInvoiceByDateRange"
                        :disabled="$this->resultCount === 0"
                    >
                        Download Invoice
                    </x-filament::button>
                                    ...
                                    <td style="white-space: nowrap;">
                                        <div style="display: inline-flex; gap: 0.5rem;">
                                            ...
                                            <button
                                                ...
                                                @if(isset($this->downloadingNumbers[$row['number'] . '_invoice'])) disabled @endif
                                                style="
                                                    display: inline-flex;
                                                    align-items: center;
                                                    justify-content: center;
                                                    ...
                                                    cursor: pointer;
                                                    outline: none;
                                                    opacity: {{ isset($this->downloadingNumbers[$row['number'] . '_invoice']) ? '0.7' : '1' }};
                                                    pointer-events: {{ isset($this->downloadingNumbers[$row['number'] . '_invoice']) ? 'none' : 'auto' }};
                                                "
                                                title="Download Invoice untuk {{ $row['number'] }}"
                                            ...
                                            >
                                                ...
                                                @if(!isset($this->downloadingNumbers[$row['number'] . '_invoice']))
                                                    <span>Invoice</span>
                                                @else
                                                    <span style="display: inline-flex; align-items: center; gap: 0.25rem;">
                                                        <svg style="animation: spin 1s linear infinite; height: 1rem; width: 1rem; color: #fff;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
