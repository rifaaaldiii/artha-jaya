                                            ...
                                            <div class="datepicker-container" x-data="jadwalDatePicker" x-init="init()" @click.away="calendarOpen = false" wire:ignore>
                                                ...
                                                <div x-show="calendarOpen"
                                                    ...
                                                    <div class="datepicker-days">
                                                        <template x-for="(day, index) in days" :key="index">
                                                            <div class="datepicker-day"
                                                                 ...
                                                                 :title="day.isBooked ? 'Tanggal sudah penuh (5 jadwal)' : (day.empty ? '' : day.date)"
                                                            >
                                                    ...
                                                    <div x-show="disabledDates.length > 0" class="datepicker-info">
                                                        ...
                                                        <span>Tanggal berwarna <span style="color: #dc2626; font-weight: 600;">merah</span> sudah penuh (5 jadwal)</span>
                                                    </div>
                                                </div>
                                            </div>
            ...
            selectDate(day) {
                ...
                if (day.disabled) {
                    if (day.isBooked) {
                        ...
                        this.conflictMessage = 'Tanggal ' + parts[2] + '/' + parts[1] + '/' + parts[0] + ' sudah penuh (5 jadwal). Pilih tanggal lain.';
                    }
                    return;
                }
